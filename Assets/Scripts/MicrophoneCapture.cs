...
public class MicrophoneCapture : MonoBehaviour
{
    ...
    **/
    const string PROJECT_ID = "covid19agent-tfwfjn";
    const string email = "pythonspeechagent@covid19agent-tfwfjn.iam.gserviceaccount.com";
    /* Make sure it is in the Assets Folder so that this is only the name */
    string certPath = "covid19agent.p12";

    // This needs to be changed to access you script
    public DrMarioBehavior myScript;
    ...
    void Start()
    {
        ...
        this.myScript = GameObject.FindObjectOfType(typeof(DrMarioBehavior)) as DrMarioBehavior;
    ...
    void OnGUI()
    {
        ...
        if (micConnected)
        {
            ...
            if (!Microphone.IsRecording(null))
            {
                ...
                if (GUI.Button(new Rect(Screen.width / 4 - 50, Screen.height / 3 - 25, 100, 100), "Record"))
                {
            ...
            else //Recording is in progress
            {
                ...
                if (GUI.Button(new Rect(Screen.width / 4 - 50, Screen.height / 3 - 25, 100, 100), "Stop and Play!"))
                {
